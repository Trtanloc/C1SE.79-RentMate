...
const Dashboard = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    setError(null);
    setSuccess(null);
    const validationErrors = validatePropertyForm(form, photoFiles, Boolean(editingId));
    ...
    const photoUrlList = (form.photos || '')
      ...
      .filter(Boolean)
      .slice(0, 12);
    const mapEmbedUrl = normalizeMapUrl(form.mapEmbedUrl);
    ...
    try {
      ...
      if (mapEmbedUrl) {
        formData.append('mapEmbedUrl', mapEmbedUrl);
      }
