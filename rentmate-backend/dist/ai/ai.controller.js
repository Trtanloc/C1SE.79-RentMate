...
let AiController = class AiController {
    ...
    handleChat(chatRequestDto, request) {
        const user = request.user;
        if (!user || user.role !== user_role_enum_1.UserRole.Tenant) {
            throw new common_1.ForbiddenException('Only tenants can chat with the AI assistant.');
        }
...
], AiController.prototype, "handleChat", null);
