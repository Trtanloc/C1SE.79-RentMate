...
let PropertiesService = class PropertiesService {
    ...
    create(ownerId, createPropertyDto) {
        const property = this.propertiesRepository.create(Object.assign(Object.assign({}, createPropertyDto), { ownerId }));
    ...
    async update(id, updatePropertyDto) {
        const property = await this.propertiesRepository.preload(Object.assign({ id }, updatePropertyDto));
        if (!property) {
            throw new common_1.NotFoundException(`Property with id ${id} not found`);
        }
        return this.propertiesRepository.save(property);
